...
from favorit.views import show_favorit, show_json_favorit, show_json_rumah_makan_by_favorit, update_favorit_restoran, update_favorit_favorit
...
urlpatterns = [
    ...
    path('json-rm-favorit/',show_json_rumah_makan_by_favorit, name='show_json_rumah_makan_by_favorit'),
